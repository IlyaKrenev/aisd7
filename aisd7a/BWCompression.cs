...
namespace Burrows_Wheeler_Data_Compression
{
    ...
    public class HaCompression
    {
        public static byte[] Compress(byte[] Data)
        {
            byte[] hf = HuffmanCoding.Encode(Data);
            return hf;
        }
    ...
    public class MTFCompression
    {
        public static byte[] Compress(byte[] Data)
        {
            byte[] mtf = MoveToFrontCoding.Encode(Data);
            return mtf;
        }

        public static byte[] Decompress(byte[] data)
        {
            byte[] imtf = MoveToFrontCoding.Decode(data);
            return imtf;
        }
    }
}
